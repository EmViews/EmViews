$(document).ready(function() {
        ...
        $(document).on("click", ".btn", function() {
            ...
            // Example query:
            // https://www.reddit.com/search.json?q=computer+wrist+pad+review&limit=10
            $("#reddit-results").empty();
            var searchQuery = $("#product-input").val().trim();
            var limit = 10;
            var queryURL = "https://www.reddit.com/search.json?q=" + searchQuery + "+review&limit=" + limit + "&sort=hot"
